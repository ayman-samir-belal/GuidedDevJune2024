namespace Terrasoft.Core.Process
{
	...
	#region Class: UsrCalculateAverageRealtyPriceProcessUsrRealty1MethodsWrapper

	/// <exclude/>
	public class UsrCalculateAverageRealtyPriceProcessUsrRealty1MethodsWrapper : ProcessModel
	{

		public UsrCalculateAverageRealtyPriceProcessUsrRealty1MethodsWrapper(Process process)
			: base(process) {
